...
const MainSection = () => {
  ...
  const handleBuy = async () => {
    ...
    try {
      if (amount < 0.0065) {
        toast.error("Minimum buy is 0.0065 BNB");
        setLoading(false);
        return;
      }
        ...
        <div className="ggtt">
          <div className="col-lg-7">
            <h1 class="banner-title">
              <span>XLD</span> The future
              <br />
              of Alts
            </h1>
            <h4 class="banner-subtitle">
              Buy $XLD and make your wallet great Again!
            </h4>
            <a
              href="/"
              ...
              <div class="presale-card">
                <div class="presale-card-left">
                  ...
                  <div class="presale-card-msg">
                    <p>Price here is cheaper than pancakeswap</p>
                  </div>
                  <div class="presale-card-counter">
                    <p>CEX listings coming soon</p>
                  </div>
